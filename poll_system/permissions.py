...
from poll_system.models import PollRecipient
...
class CanUpdateRecipient(permissions.BasePermission):
    """
    ...
    def has_permission(self, request, view):
        ...
        try:
            pollRecipient = PollRecipient.objects.get(
                pk=view.kwargs['pk'])
        except:
        ...
        if request.user == pollRecipient.recipient:
            return True
        return False
